...
anos = [str(datetime.now().year)]  # Pode ser expandido para múltiplos anos
...
st.markdown(
    f"""
    <div style="background-color:#004B8D; padding:10px; border-radius:10px; text-align:center; color:white; font-size:16px; width:250px; margin:auto;">
